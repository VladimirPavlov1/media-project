...
//     return Notiflix.Notify.failure('Пожалуйста, введите ваш запроc');
//   }
...
//   console.log(destrResults)
//   refs.gallery.insertAdjacentHTML('beforeend', movieList(destrResults));
// }
...
//       refs.btn.textContent = totalPages;
//       // console.log(data)
